...
(function () {
    ko.applyBindings(new InputVM(dataSvc.getCountries()), document.getElementById('inputs'));
    ko.applyBindings(new FlexChartVM(dataSvc.getCountrySales()), document.getElementById('flexChart'));
    ko.applyBindings(new FlexGridVM(dataSvc.getCountryData(100)), document.getElementById('flexGrid'));
    ko.applyBindings(new GaugeVM(), document.getElementById('gauges'));
    ko.applyBindings(new FlexPieVM(dataSvc.getFruitData()), document.getElementById('flexPie'));
})();