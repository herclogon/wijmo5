namespace wijmo.material {
     ...
     */
    export class ColorWheel extends wijmo.Control {
        ...
        constructor(element: any, options?) {
            ...
            this._svg.addEventListener('click', (e) => {
                var g = <Element>wijmo.closest(e.target, 'g'),
        ...
        get primary(): string {
            return isArray(this._palette) && isNumber(this._primary) && this._primary > -1
        ...
        get accent(): string {
            return isArray(this._palette) && isNumber(this._accent) && this._accent > -1
        ...
        themeChanged = new Event();
        onThemeChanged(e?: EventArgs) {
        ...
        _createWheel() {
            ...
            // sanity
            if (!isArray(this._palette) || this._palette.length < 4) {
                return;
            }
